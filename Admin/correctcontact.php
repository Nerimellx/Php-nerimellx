			...
			<div class="container">
				...
				<ul class="sf-menu">
					...
					<li>
						...
						<ul>
							<li>
								<a href="index.php?type=Cloth">Белье</a>
							<?php
       					...
       					{
								?>
								<li><a href="index.php?id=<?php echo $cat['id']?>&type=<?php echo $cat['Type']?>"><?php echo $cat['Categor']?></a></li>
								<?php
								}
							...
							while ( $Else = mysqli_fetch_assoc($Elsecat) )
       						{
							?>
							<li><a href="index.php?id=<?php echo $Else['id']?>&type=<?php echo $Else['Type']?>"><?php echo $Else['Categor']?></a></li>
							<?php
							}
							?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="contact col-md-10 col-md-offset-1">
					...
					<div class="col-md-9">
				<form method="POST">
					<label>Number: </label><input name="Number" cols="50" value='<?php echo $contx['number'];?>'></input><br>
					</div>
				</div>
				...
				<div class="contact col-md-10 col-md-offset-1">
					...
					<div class="col-md-9">
					<label>Instagrm: </label><input name="Instagrm" cols="50" value='<?php echo $contx['instagram'];?>'></input><br>
					</div>
				</div>
				...
				<div class="contact col-md-10 col-md-offset-1">
					...
					<div class="col-md-9">
					<label>Email: </label><input name="Email" cols="50" value='<?php echo $contx['email'];?>'></input><br>
